...
class PinterestPinata(object):
    ...
    def __init__(self, email=None, password=None, username=None, proxies=None):
        ...
        urllib.request.HTTPRedirectHandler.max_redirections = 2
    ...
    def boards(self, username):
        ...
        boards = [re.findall("\d+", board)[0] for board in re.findall(r'"board_id":\s"\d*"', res[0].decode('utf-8'))]
    ...
    def pin(self, board_id=None, description=None, image_url=None, link=None):
        ...
        if not board_id or not description or not image_url or not link:
            raise PinterestPinataException('Illegal arguments board_id={board_id}, description={description}, image_url={image_url}, link={description}'.format(board_id=board_id, description=description, image_url=image_url, link=link))
    ...
    def search_boards(self, query):
        ...
        res, headers, cookies = self._request(url='http://www.pinterest.com/search/boards/?q=' + query,
    ...
    def search_pins(self, query):
        ...
        res, headers, cookies = self._request(url='http://www.pinterest.com/search/pins/?q=' + query+'&page=2&limit=50',
    ...
    def search_users(self, query):
        ...
        res, headers, cookies = self._request(url='http://www.pinterest.com/search/users/?q=' + query ,
